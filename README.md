...
## ☁️ Part 4: AWS Deployment (Cloud Extra)
...
Security Group: Ensure you create rules to allow traffic:

✅ Allow SSH traffic (Port 22, Source: Anywhere)

✅ Allow HTTP traffic (Port 80, Source: Anywhere)

✅ Allow Proxy traffic (Port 9999, Type: Custom TCP, Source: Anywhere)
...
Re-login via ssh to the server.
...
```
4. Verify
Test the Server: Open your browser to http://<your_public_ip>. You should see your index.html.

Test the Proxy: Open your local terminal and run:

```

curl -i -x http://<your_public_ip>:9999 [http://example.com](http://example.com)
```